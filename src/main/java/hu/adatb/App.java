...
public class App extends Application {
    ...
    private MenuBar createMenuBar(Stage stage){
        ...
        Menu authorMenu = new Menu("Szerzők");

        menuBar.getMenus().addAll(userMenu, bookMenu, publisherMenu, shopMenu, couponMenu, genreMenu, stockMenu, orderMenu, seriesMenu, authorMenu);
        ...
        addBook.setOnAction(e -> new AddBookDialog(bookController));
        listBook.setOnAction(e -> new ListBookDialog(bookController));
        ...
        //addAuthor.setOnAction(e -> new AddAuthorDialog(authorController));
        //listAuthor.setOnAction(e -> new ListAuthorDialog(authorController));
        ...
        authorMenu.disableProperty().bind(sessionController.isAdmin().not());
        ...
        authorMenu.getItems().addAll(addAuthor, listAuthor);
